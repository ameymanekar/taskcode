...
input[type=text]:focus, input[type=password], [type=email]:focus {
...
<form method="POST" action="upload">
  <div class="container">
    ...
    <label class="container">Publishers
 	 <input type="radio" checked="checked" value="Publishers" name="radio">
  	<span class="checkmark"></span>
		</label>
	<label class="container">Author
  <input type="radio" value="Author" name="radio">
  <span class="checkmark"></span>
	</label>
		<label class="container">Reader
  <input type="radio" value="Reader" name="radio">
  <span class="checkmark"></span>
	</label>
    <hr>
